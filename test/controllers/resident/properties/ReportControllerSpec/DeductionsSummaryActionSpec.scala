...
class DeductionsSummaryActionSpec @Inject()(val pdfGenerator: PdfGenerator) extends UnitSpec with WithFakeApplication with FakeRequestHelper with MockitoSugar with CommonMocks {
