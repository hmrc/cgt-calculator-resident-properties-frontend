...
class PropertiesFinalSummaryViewSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {
  ...
  //with reliefs (letting + PRR)

  //with brought forward loss

  //with remaining brought forward loss

  //legislation - yes - 31 march 1982 otherwise disposal date

  //gave away

  //date above tax years
  "PropertiesFinalSummaryView when supplied with a date above the known tax years" should {
