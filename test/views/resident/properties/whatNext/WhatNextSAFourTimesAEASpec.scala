...
class WhatNextSAFourTimesAEASpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {
  ...
  "The whatNextSAFourTimesAEA view" should {
    ...
    "have the first paragraph of ..." in {

    }

    "have the second paragraph of ..." in {
