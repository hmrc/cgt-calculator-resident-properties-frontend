...
class BoughtForLessThanWorthViewSpec extends CommonPlaySpec with WithCommonFakeApplication with BaseViewSpec {
  ...
  "Sell for less view with an empty form" should {
    ...
    lazy val view = boughtForLessThanWorthView(boughtForLessThanWorthForm, Some("back-link"))(using fakeRequest, testingMessages)
  ...
  "Sell for less view with a filled form" which {
    lazy val view = boughtForLessThanWorthView(boughtForLessThanWorthForm.fill(BoughtForLessThanWorthModel(true)), Some("back-link"))(using fakeRequest, testingMessages)
    lazy val doc = Jsoup.parse(view.body)
  ...
  "Sell for less view with form errors" should {
    ...
    lazy val view = boughtForLessThanWorthView(form, Some("back"))(using fakeRequest, testingMessages)
    lazy val doc = Jsoup.parse(view.body)
