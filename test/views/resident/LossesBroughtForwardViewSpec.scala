...
class LossesBroughtForwardViewSpec extends UnitSpec with WithFakeApplication with FakeRequestHelper {
  ...
  "Reliefs view" should {
    ...
    lazy val view = views.lossesBroughtForward (
      lossesBroughtForwardForm, postAction, "", TaxYearModel("2015/16", true, "2015/16"), false, "home-link", "navTitle")(fakeRequest, applicationMessages)
  ...
  "Losses Brought Forward view with pre-selected value of yes" should {
    ...
    lazy val view = views.lossesBroughtForward(form, postAction, "", TaxYearModel("2015/16", true, "2015/16"), true, "home", "navTitle")(fakeRequest, applicationMessages)
    lazy val doc = Jsoup.parse(view.body)
