  ...
  "Creating a form using an invalid post" when {
    ...
    "supplied with no data for amount" should {
      ...
      "associate the correct error message to the error" in {
        form.error("amount").get.message shouldBe messages.Errors.worthWhenGiftedMandatoryAmount
      }
    }
    ...
    "supplied with non numeric input for amount" should {
      ...
      "associate the correct error message to the error" in {
        form.error("amount").get.message shouldBe messages.Errors.worthWhenGiftedInvalidAmount
      }
    }
    ...
    "supplied with an amount with 3 numbers after the decimal" should {
      ...
      "associate the correct error message to the error" in {
        form.error("amount").get.message shouldBe messages.Errors.worthWhenGiftedDecimalError
      }
    }
    ...
    "supplied with an amount that's greater than the max" should {
      ...
      "associate the correct error message to the error" in {
        form.error("amount").get.message shouldBe messages.Errors.worthWhenGiftedMaximumAmount
      }
    }
    ...
    "supplied with an amount that's less than the zero" should {
      ...
      "associate the correct error message to the error" in {
        form.error("amount").get.message shouldBe messages.Errors.worthWhenGiftedMinimumAmount
      }
    }
  }
}
