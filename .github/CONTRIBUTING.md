# Contributing Guidelines for cgt-calculator-resident-properties-frontend

Hi!  Thanks for taking the time to contribute to the [HMRC Multichannel Digital Tax Platform](https://hmrc.github.io) (MDTP)

We welcome contributions to cgt-calculator-resident-properties-frontend.  By following these guidelines you will greatly improve the likelihood of your change being accepted and merged.
...
Once you've identified (or created) an [issue](https://github.com/hmrc/cgt-calculator-resident-properties-frontend/issues) to work on, please follow these guidelines to contribute code:
